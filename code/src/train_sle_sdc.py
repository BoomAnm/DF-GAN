...
from lib.modules import sample_one_batch as sample, test as test, train_sle_sdc as train
from lib.datasets_flower import get_fix_data
...
def parse_args():
    ...
    parser.add_argument('--cfg', dest='cfg_file', type=str, default='../cfg/flower.yml',
